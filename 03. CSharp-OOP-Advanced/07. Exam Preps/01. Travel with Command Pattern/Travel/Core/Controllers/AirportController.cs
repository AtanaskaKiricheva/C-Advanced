namespace Travel.Core.Controllers
{
    ...
    public class AirportController : IAirportController
    {
        ...
        public string RegisterPassenger(string[] args)
        {
        ...
        public string RegisterBag(string[] args)
        {
            string username = args[0];
        ...
        public string RegisterTrip(string[] args)
        {
        ...
        public string CheckIn(string[] args)
        {
            string username = args[0];
            string tripId = args[1];
            IEnumerable<int> bagIndices = args.Skip(2).Select(int.Parse);
